    ...
    <div class="navigation">
        ...
        <div class="burger-menu">
            ...
            <nav class="burger-menu__nav">
                ...
                <a href="#" class="burger-menu__link">Лицензия</a>
                <a href="#" class="burger-menu__link">Контракт</a>
                <a href="#" class="burger-menu__link">О компании</a>
                <a href="#" class="burger-menu__link">Блог</a>
                <a href="#" class="burger-menu__link">Контакты</a>
                <a href="#" class="burger-menu__link"><span class="icon-mail"></span>info@galant-cosmetic.ru</a>
                <a href="#" class="burger-menu__link"><span class="icon-call"></span>+7 (495) 133-75-91</a>
                <!-- <a href="#" class="burger-menu__link"><span class="icon-mail"></span>info@galant-cosmetic.ru</a> -->
            </nav>
        ...
        <div class="menu">
            <ul class="menu__list">
                ...
                <li><a class="menu__link menu__links" href="#">Контракт</a></li>
                <li><a class="menu__link menu__links" href="#">О компании</a></li>
                <li><a class="menu__link menu__links" href="#">Блог</a></li>
                <li><a class="menu__link menu__links" href="#">Контакты</a></li>
            </ul>
        </div>
